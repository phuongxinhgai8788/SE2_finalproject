        ...
        <script>
          $('table tr')
            .on('click', function (e) {
              const id = $(this)
                .data('id')
              const url = '${pageContext.request.contextPath}/orders-management/details?id=' + id
              window.location = url
            })
        </script>
    </jsp:attribute>
        ...
        <div class="card mt-3">
            <div class="card-content">
                <div class="card-body">
                    <h5 class="card-title">
                        Orders Management
                        <a href="${pageContext.request.contextPath}/orders-management/create"
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${dataList}"
                                ...
                                <tr data-id="${item.id}">
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/orders-management/update?id=${item.id}"
