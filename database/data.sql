...
insert into dhawuidhi.inventories (id, name, price, source, thumbnailUrl, tags)
...
insert into dhawuidhi.roles (id, name)
values  (1, 'Director'),
        (2, 'Manager'),
        (3, 'Transporter');

insert into dhawuidhi.transportingUnits (id, name)
values  (1, 'FastExpress'),
        (2, 'J&T Express');        

insert into dhawuidhi.labors (id, name, dateOfBirth, phoneNumber, roleId, transportingUnitId, password, email)
...
insert into dhawuidhi.orders (id, customerName, address, phoneNumber, transportingUnitId, transporterId, notes, createdDate, status)
...
insert into dhawuidhi.orderDeliveryDetails (orderId, updatedDate, notes)
...
insert into dhawuidhi.orderDetails (orderId, itemId, price, quantity)
values  (1, 1, 20, 5),
        (1, 4, 24, 6),
        (1, 7, 88, 2),
        (2, 3, 50, 1),
...
insert into dhawuidhi.warehouses (id, address, managerId)
